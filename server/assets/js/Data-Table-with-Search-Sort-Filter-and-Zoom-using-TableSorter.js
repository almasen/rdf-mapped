$(function() {
    ...
    let _zoomLevel = 100;
    const oDiv = document.getElementById("ipi-table");
    ...
    $('.resetsaved').click(function() {
        ...
        const $message = $('<span class="results"> Reset</span>').insertAfter(this);
        setTimeout(function() {
            $message.remove();
        }, 500);
        return false;
    ...
    $('button[data-filter-column]').click(function() {
        ...
        const filters = [];
        const $t = $(this);
        const col = $t.data('filter-column'); // zero-based index
        const txt = $t.data('filter-text') || $t.text(); // text to add to filter
    ...
    $('table').bind('filterEnd', function(event, filteredRows) {
        ...
        if (typeof rowCount !== "undefined") {
            const text = document.createTextNode(filteredRows.filteredRows);
